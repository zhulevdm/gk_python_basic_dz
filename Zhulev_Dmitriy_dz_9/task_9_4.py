class Car:
    ...
    def turn(self, direction: str) -> None:
        ...
        self.driving_direction = ['направо', 'налево', 'прямо', 'назад']
        if self.direction not in self.driving_direction:
...
class TownCar(Car):
    ...
    def show_speed(self) -> None:
        """
        Проверка текущей скорости автомобиля  на превышение свыше 60 км/час
        """
        if self.speed > 60:
            print('Alarm!!! Speed!!!')
        else:
...
class WorkCar(Car):
    def show_speed(self) -> None:
        """
        Проверка текущей скорости автомобиля на превышение свыше 40 км/час
        """
        if self.speed > 40:
            print('Alarm!!! Speed!!!')
        else:
